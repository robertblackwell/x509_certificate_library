...
int mkreq(X509_REQ **req, EVP_PKEY **pkeyp, int bits, int serial, int days)
    ...
    add_ext(exts, NID_key_usage, (char*)"critical,digitalSignature,keyEncipherment");

    /* This is a typical use for request extensions: requesting a value for
     * subject alternative name.
     */

    add_ext(exts, NID_subject_alt_name, (char*)"email:steve@openssl.org");

    /* Some Netscape specific extensions */
    add_ext(exts, NID_netscape_cert_type, (char*)"client,email");
    add_ext(exts, NID_subject_alt_name, (char*)"email:steve@openssl.org");
    add_ext(exts, NID_subject_alt_name, (char*)"email:one.steve@openssl.org");
    add_ext(exts, NID_subject_alt_name, (char*)"email:two.steve@openssl.org");
